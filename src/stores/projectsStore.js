    ...
    projects: [
      {
        ...
        "description": "<p>At USAID’s Food for Peace (FFP), an external team was already contracted to build this tool. However, they were over-extended and had underestimated the project’s urgency. FFP’s Monitoring and Evaluation Team (M&E) reached out to Macfadden to see what can be done in roughly 4 months. We formed a small team of three to take on the project. Mike Weaver was the project’s tech lead, and I led UX/UI design and development.</p><p>As discussions progressed, we learned the project’s requirements were more complex than we initially thought. At first, it was presented as a simple form, but we soon learned that not only we would be collecting data for over 100 analyses, we would need an accounts system to track forms through to completion for dozens of partner organizations. This would allow the orgs to fulfill their annual reporting requirement, and ultimately aid FFP’s report to Congress on the effectiveness of various programs.</p><p>Requirements grew in complexity with each meeting. The app would also need to collect earlier projections and compare them to outcomes. Partner organizations would need to enlist multiple users to complete reports, and reports would need to progress through various FFP approvals before being accepted, so FFP would need a way to provide feedback.</p><p>Mike chose Drupal to build the application, mostly for its built-in accounts system, and the three of us began to identify modules that would aid with various requirements. I presented designs and diagrams to the M&E team. Mika focused on building out the forms. All three of us put in overtime to see the project through. We managed to complete it in under three months, well before our deadline, and rich with the “nice to have” features requested along the way.</p><p>The bond I formed with the team through our hard work made this one of my most rewarding experiences. My proudest moment wasn’t even the award we received from USAID. It was when I asked Mika to present the final application to stakeholders, after observing how incredibly hard (and brilliantly) he worked on the project, and how much he deserved the spotlight.</p>",
      ...
      */
      ...
      },
      {
        ...
        "description": "<p>BHA’s Strategic Communications Division Chief noticed that the BHA Jobs website was in desperate need of a redesign. Initially, she simply asked me to work with a designer to mockup a new look, since the project belonged to another team that lacked design expertise. But the design was so simple and clean, I was tempted to build it out anyway.</p><p>From the designer’s mockup, I constructed a responsive frontend and handed the assets off to the .net developer, who only needed a few meetings to integrate the backend. This was such a simple and easy project, it was a delight to work on, and it didn’t hurt that it produced a great deal of praise for everyone involved.</p>",
      ...
      },
      {
        ...
        "description": "<p>The Wordpress site was due for a redesign. It had been neglected for too long, and now it appeared dated. After our success with the BHA Jobs website, the graphic designers and I were eager to take on another fun project.</p><p>For this project, I took a content-first approach. Several pages had unique layouts, so we needed drafts of near-final content to proceed. I began by outlining the site’s menus and taking an inventory of each page. Thereafter, I copied the text to a separate document and worked with writers from the Content Team to refine it.</p><p>I went through a few different drafts with the design team to produce feasible components. After high-fidelity mockups were finalized, I expected to build the front-end, but the project took an unexpected turn: due to security concerns, IT decided to migrate the site to ServiceNow. My new role would be to advise a ServiceNow-dedicated team as they translate the designs.</p>",
        "skills": ["HTML/CSS"],
        "link": {
          "type": "website",
      ...
      },
      {
        ...
        "description": "<p>As a requirement for its contract with USAID’s Bureau for Humanitarian Assistance, Credence was tasked with developing a reference tool to aid in identifying vendors available for emergency crisis responses. I was asked to help conceptualize the tool and lead a team to build it. For this project, I requested one additional developer, to assist with the backend.</p><p>I began by working with the contract’s Program Director to discover requirements. To identify use cases, I also met with intended users. We determined the most important need was the ability to cross-reference geographic locations and service categories. A map would provide an easy interface, alongside other UI components for listing and filtering vendors.</p><p>I designed a low-fidelity mockup in Figma and worked with the client to design a database schema from sample data. After designs were approved, we moved to development. The REST API was assigned to our junior developer, and I focused on the frontend. Due to familiarity, I chose Vue 3 and Leaflet as our framework and mapping libraries, respectively.</p>",
